...
def Nessus_Extractor(Folder_Path):
	...
	print BOLD+P+"Total Critical Vulnerabilities Found: "+END,countcritical
	...
	print BOLD+B+"Total Info Vulnerabilities Found: "+END,countinfo
